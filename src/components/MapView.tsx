...
const MapView = ({ searchQuery }: { searchQuery: string }) => {
  ...
  // Simulated coordinates for tools (in real app, these would come from the database)
  const toolsWithCoords = mockTools.map((tool, index) => ({
    ...tool,
    coordinates: {
          ...
          .setPopup(
            new mapboxgl.default.Popup().setHTML(`
              <div class="p-2">
                ...
                <p class="text-sm text-gray-600">${tool.price}€/${tool.period}</p>
                <p class="text-sm">${tool.location}</p>
              </div>
            `)
          )
          .addTo(map);
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between mt-1">
                        <span className="font-semibold text-sm">{tool.price}€/{tool.period}</span>
